...
const SPOTIFY_REDIRECT_URI = `http://pcvm701-1.emulab.net:3000/callback`;
...
function connectToDatabase() {
  pool.getConnection((error, connection) => {
    if (error) {
      ...
      connection.release();
      app.listen(port, () => {
        console.log(`Server running at http://pcvm701-1.emulab.net:3000/`);
